;(function ($, window, document, undefined) {
  ...
  Foundation.libs['magellan-expedition'] = {
    ...
    settings : {
      active_class: 'active',
      threshold: 800, // pixels from the top of the expedition for it to become fixes
      destination_threshold: 800, // pixels from the top of destination for it to be considered active
